...
### Chat Widget (relayapp.pro + docs.relayapp.pro)
- Source lives in `archon-ios` repo (Cloudflare Pages project `archon-docs`)
- Loaded via CDN: `<script src="https://docs.relayapp.pro/js/chat-widget.js">`
- TODO: Add Auto / Shaggoth selector to the chat bubble UI
- Currently has hardcoded responses (per TODO.md)
...
- [ ] Find/clone `archon-ios` repo locally
- [ ] Update `chat-widget.js` to add Auto/Shaggoth selector
- [ ] Deploy updated widget to Cloudflare Pages

### Phase 4: Shaggoth API Alignment
- [ ] Confirm Shaggoth REST API shape (POST /api/chat request/response schema)
- [ ] Add conversation history support if Shaggoth supports sessions
- [ ] Add streaming response support if Shaggoth supports SSE
